# -*- coding: utf-8 -*-
"""
Created on Tue Sep 19 16:08:23 2017
...
def output(clique_list=None, number_cells=None):
...
def uniq(clique_list=None, snn=None):
...
def findQuasiCliq(snn=None, r=None):
    if r is None:	r=0.7 # 
...
# end 1.
################       end of algorithm         #########
def snn_cliq(snn,merge_cutoff=0.5,r_cutoff=0.7,number_cells=None):
    """SNN-Cliq clustering"""
